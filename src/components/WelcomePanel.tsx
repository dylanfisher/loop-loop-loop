...
const WelcomePanel = ({ onClose }: WelcomePanelProps) => (
  <section className="panel welcome-panel">
    ...
    <p className="welcome-panel__body">
      ...
      into a deck and defining a loop directly on the waveform. Then use the FX section to change
      rhythm, texture, and tone in real time. Save anything interesting as a clip and reuse it in
      another deck.
    </p>
    ...
    <div className="welcome-panel__columns">
      <article className="welcome-panel__card">
        <h3>Start Simple</h3>
        <p>
          Press <strong>A</strong> to add decks. Press <strong>Space</strong> to play or pause the
          active deck.
        </p>
      </article>
      <article className="welcome-panel__card">
      ...
      <article className="welcome-panel__card">
        <h3>Set a Loop</h3>
        <p>
          Drag the waveform loop handles to isolate a phrase. Short loops (1-4 seconds) are easiest
          to sculpt and layer.
        </p>
      </article>
      <article className="welcome-panel__card">
        ...
        <p>
          Keyboard controls follow the last clicked deck. Click a deck before using shortcuts like
          loop toggle, zoom, or rearranger.
        </p>
      </article>
      <article className="welcome-panel__card">
        <h3>Shape Time</h3>
      ...
      <article className="welcome-panel__card">
        ...
        <p>
          Clip Rack clips can optionally load saved deck FX settings. Toggle the clip FX badge on
          or off depending on whether you want a clean or styled reload.
        </p>
      </article>
      <article className="welcome-panel__card">
        <h3>Global Capture</h3>
        <p>
          Clip Recorder captures the master output. This is useful for printing happy accidents and
          quickly reusing them as new source material.
        </p>
      </article>
      <article className="welcome-panel__card">
        <h3>Capture Ideas</h3>
