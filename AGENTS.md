...
- Keep files modular and logically scoped. Avoid adding large mixed-concern files; extract cohesive hooks/utils/components as files grow.
- Treat unusually large files as refactor candidates. Prefer incremental splits that preserve behavior rather than adding more responsibilities to a single file.
